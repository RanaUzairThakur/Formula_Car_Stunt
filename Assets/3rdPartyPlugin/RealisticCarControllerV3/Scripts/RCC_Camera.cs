...
public class RCC_Camera : MonoBehaviour
{
    ...
    public float TPSHeight = 6.5f;                  // The height we want the camera to be above the target for TPS camera mode.
    ...
    public float TPSPitchAngle = 12f;           // Pitch angle.
    ...
    void OnEnable()
    {
        ...
        //Invoke(nameof(assigne_camrcc),0.05f);
    ...
    void GetTarget()
    {
        playerCar = GameObject.FindGameObjectWithTag("Player").GetComponent<RCC_CarControllerV3>();
    ...
    void Update()
    {
        ...
        playerSpeed = Mathf.Lerp(playerSpeed, playerCar.speed, Time.deltaTime * 52f);
        ...
        else
        {
            ...
            if (thisCam.fieldOfView >= TPSMaximumFOV)
            {
                ...
                thisCam.fieldOfView = Mathf.Lerp(thisCam.fieldOfView, targetFieldOfView, Time.deltaTime * 0.1f);
    ...
    //private void assigne_camrcc()
    //{
    //    if (playerCar)
    //        playerCar.RCCCamera = this;
    //}
