...
namespace Michsky.LSS
{
    ...
    public class SpinnerItem : MonoBehaviour
    {
       ...
       // public LoadingScreen loadingScreen;
        ...
        //        try
        //        {
        //            //loadingScreen = gameObject.GetComponentInParent<LoadingScreen>();                 
        //        }

        //        catch
        //        {
        //            Debug.Log("No Loading Screen found. Assign it manually, otherwise you'll get errors about it.", this);
        //        }
        //    }
        //}
