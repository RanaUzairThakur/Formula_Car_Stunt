...
public class SplashEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (splash.m_Type == USplash.SplashType.Movie)
        {
            ...
            splash.SplashClip = EditorGUILayout.ObjectField("Video Clip: ", splash.SplashClip, typeof(VideoClip), allowSceneObjects) as VideoClip;
        ...
        if (splash.m_Type == USplash.SplashType.Animation)
        {
            ...
            splash.m_volume = EditorGUILayout.Slider("Volume: ", splash.m_volume, 0f, 1.0f);
