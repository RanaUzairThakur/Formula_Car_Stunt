...
public class USplashScreen : MonoBehaviour
{
    ...
    public void GameLink()
    {
        if (Application.internetReachability != NetworkReachability.NotReachable)
            Application.OpenURL("https://play.google.com/store/apps/details?id=com.grand.jail.prison.escape");
    }
    /// <summary>
    /// 
    /// </summary>
    ...
    void ProgreesLoad()
    {
        if (ProgreesSlider != null && async != null)
        {
            ...
            ProgreesSlider.value = Mathf.Lerp(ProgreesSlider.value, p, Time.deltaTime * 0.2f);
