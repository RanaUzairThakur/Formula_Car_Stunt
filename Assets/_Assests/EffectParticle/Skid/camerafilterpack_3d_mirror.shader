			...
			Program "vp" {
				SubProgram "gles hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat2 = vec4(Fade) * u_xlat2 + u_xlat10_1;
					    u_xlat2 = u_xlat2 * vec4(vec4(Lightning, Lightning, Lightning, Lightning)) + (-u_xlat10_1);
					    SV_Target0 = u_xlat0.wwww * u_xlat2 + u_xlat10_1;
					    return;
					}
				...
				SubProgram "gles3 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat2 = vec4(Fade) * u_xlat2 + u_xlat16_1;
					    u_xlat2 = u_xlat2 * vec4(vec4(Lightning, Lightning, Lightning, Lightning)) + (-u_xlat16_1);
					    SV_Target0 = u_xlat0.wwww * u_xlat2 + u_xlat16_1;
					    return;
					}
