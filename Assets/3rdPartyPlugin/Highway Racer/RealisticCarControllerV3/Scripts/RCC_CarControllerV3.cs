...
public class RCC_CarControllerV3 : RCC_Core
{
    ...
    void Update()
    {
        ...
        Inputs();
        //Reversing Bool.
        if (brakeInput > .1f && transform.InverseTransformDirection(rigid.velocity).z < 1f && canGoReverseNow && automaticGear && !semiAutomaticGear && !changingGear && direction != -1)
    ...
    private void Wheels()
    {
        ...
        for (int i = 0; i < allWheelColliders.Length; i++)
        {
            ...
            if (!appliedBrake && brakeInput >= .001f)
            {
    ...
    /// </summary>
    /// 
    public bool groundedFL;
    public bool groundedFR;
    public bool groundedRL;
    public bool groundedRR;
    ...
    private void NOS()
    {
        ...
        {
            SFX.set_statusAirEffect(false, isGrounded);
            if (NOSSound.isPlaying)
            {
                NOSSound.Stop();
